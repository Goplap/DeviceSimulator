...
namespace DeviceSimulation.Devices
{
    ...
    public class Computer : BaseDevice
    {
        ...
        /// <summary>
        /// Реалізація специфічних опцій для комп'ютера (шаблон Strategy)
        /// </summary>
        ...
        /// <summary>
        /// Обробка специфічних опцій для комп'ютера (шаблон Strategy)
        /// </summary>
        ...
        /// <summary>
        /// Підключення/відключення джерела безперебійного живлення
        /// </summary>
